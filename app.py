...
# --- DASHBOARD Y RANKING ---
    ...
    # CSS ESPECÍFICO SOLO PARA EL RANKING PARA QUE SEA CLARO Y PEQUEÑO
    st.markdown("""
        <style>
        ...
        /* Forzamos texto negro y fondo blanco solo en esta sección */
    ...
    try:
        ...
        with tab_r:
            ...
            def get_motivacion_html(row):
                ...
                elif perc >= 80: return '<b style="color: #2E8B57;">🚀 ÉXITO</b>'
                elif perc >= 60: return '<b style="color: #B8860B;">💪 CERCA</b>'
                elif perc >= 40: return '<b style="color: #D2691E;">📈 PROGRESO</b>'
                else: return '<b style="color: #FF4500;">🎯 VAMOS</b>'
            ...
            if not rank.empty:
                ...
                # Nombres de columnas más cortos para que quepa todo
                cols_finales = {
                ...
                # Renderizado con estilo de tabla pequeña y clara
                st.write(
                    rank_visual.style
        ...
        with tab_e:
            ...
            with col_e1:
                if not de.empty and 'Comercializadora' in de.columns:
                    ...
                    st.info("Columna 'Comercializadora' no encontrada.")
